...
$req = $pdo->prepare("INSERT INTO demandeconseil (Type, Description, Contact_Id, Agence_Id, Date, Statut) VALUES (:type, :description, :dontact_Id, :agence_Id, :date, 'En attente')");
