...
if ($standard_oupas)
{
    ...
    <div class="container">
        <form action="../actions/updateFormation.php" method="post">
            ...
            <br>
            <label>Titre :</label>
            <input type="text" name="titre" maxlength="50" required value="<?php echo htmlentities($standard[0]["Titre"]) ?>">

            <label>Description :</label>
            <input type="text" name="description" required value="<?php echo htmlentities($standard[0]["Description"]) ?>">

            <label>Durée :</label>
            <input type="number" name="duree" placeholder="En heures" required value="<?php echo htmlentities($standard[0]["Duree"]) ?>">

            <label>Niveau :</label>
            <select name="niveau" required value="<?php echo htmlentities($standard[0]["Niveau"]) ?>">
            ...
            <label>Secteur :</label>
            <input type="text" name="secteur" required value="<?php echo htmlentities($standard[0]["Secteur"]) ?>">

            <label>Date de début :</label>
            <input type="datetime-local" name="datedebut" required value="<?php echo htmlentities($standard[0]["PlanningDebut"]) ?>">

            <label>Date de fin :</label>
            <input type="datetime-local" name="datefin" required value="<?php echo htmlentities($standard[0]["PlanningFin"]) ?>">

            <label>Lieu :</label>
            <input type="text" name="lieu" required value="<?php echo htmlentities($standard[0]["Lieu"]) ?>">

            <label>Capacité d'accueil :</label>
            <input type="number" name="capacite" required value="<?php echo htmlentities($standard[0]["Capacite"]) ?>">
            ...
            <input type="text" name="materiel" placeholder="Facultatif" value="<?php echo htmlentities($standard[0]["Materiel"]) ?>">

            <label>Coût :</label>
            <input type="number" name="cout" step="0.01" placeholder="En euro" required value="<?php echo htmlentities($standard[0]["Cout"]) ?>">

            <label>Modalité d'inscription :</label>
            <input type="text" name="modalite" placeholder="Facultatif" value="<?php echo htmlentities($standard[0]["Modalite"]) ?>">

            <label>Commentaire :</label>
            <input type="text" name="commentaire" placeholder="Facultatif" value="<?php echo htmlentities($standard[0]["Commentaire"]) ?>">

            <label>Support de formation (lien) :</label>
            <input type="text" name="support" placeholder="Facultatif" value="<?php echo htmlentities($standard[0]["Support"]) ?>">
